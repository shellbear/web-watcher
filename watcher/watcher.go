...
type Watcher struct {
	...
	// The web page changes ratio. Must be between 0 and 1. Every x minutes the watcher will fetch the website page and
	// compares it with the previous version. Then it will check changes and convert these changes to a ratio. If page are
	// identical then this ratio is 1 and the ratio decrease for every changes.
	ChangeRatio float64
